...
"drift and contributed to the closure of the once lauded organization.<br> " +
...
"indifference by the arts establishment, they can be vital incubators for creative outsiders and safe havens for marginalized artists and audiences. <br>" +
...
"relationship to its listener base and local arts community, but in 1992, major changes in programming became the focal point of a conflict that threatened the bond between station, staff, and listeners. <br>" +
...
"delivers full-length, high-quality recordings of contemporary performances to your TV, desktop or mobile device.<br>" +
...
"When Safeco was acquired by the Liberty Mutual Insurance Group in the financial crisis of 2008, the collection was donated to the Washington Arts Consortium, a group of regional museums.<br>" +
...
"<div class=\"container\">" +
    ...
    "<p style=\"border-bottom: 0.5px #343a40 solid; padding-bottom: 20px;\">Ecosystem Research projects delve into a topic reaching beyond individual arts entities to examine the connections and relationships that have shaped the cultural ecosystem. These more intensive projects include MFA capstone research projects and articles by community experts including journalists, scholars, and writers. AERP began commissioning selected projects in the community in 2022.</p>" +
        "</br>" +
        "<li><a href=\"https://scholarworks.seattleu.edu/seattle-jazz-profit-or-non-profit/1/\" class=\"black\"><u><b>Seattle Jazz 1961 - 2024: Profit or Non-Profit?</b> by Paul de Barros</u></a></li>" +
        "<p style=\"border-bottom: 0.5px #343a40 solid; padding-bottom: 20px;\">Jazz started as a popular commercial music, but during the last three decades, it has come to be seen as an art form supported by the non-profit arts sector and schools. In Seattle, beginning in the 1960s, both the commercial and non-profit sectors nurtured the music. A granular look at this dual stewardship by commercial and non-profit sectors offers a fresh take on an important storyline in Seattle's rich cultural history.</p>" +
        "</br>" +
